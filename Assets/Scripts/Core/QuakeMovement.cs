...
public class QuakeMovement : MonoBehaviour
{
    ...
    [SerializeField] private bool lockCursorOnStart = true; // allow disabling cursor lock for testing
    [SerializeField] private bool autoParentCamera = false; // avoid unexpected reparenting by default
    ...
    private void Start()
    {
        ...
        if (cameraTransform == null)
        {
            ...
            if (autoParentCamera && cameraTransform != null && cameraTransform.parent != transform)
            {
