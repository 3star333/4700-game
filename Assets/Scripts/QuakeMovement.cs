...
public class QuakeMovement : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (cameraTransform == null)
        {
            ...
            if (mainCam != null)
            {
                ...
                // Make camera a child of the player for proper rotation
            ...
            {
                Debug.LogWarning("No camera found! Assign a camera to cameraTransform.");
            }
        }
    ...
    private void HandleMouseLook()
    {
        ...
        // Apply mouse/gamepad look input
        ...
        rotationX -= mouseY; // invert if you want opposite Y look
